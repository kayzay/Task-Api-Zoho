...
<style>
    ...
    .zoho_logo {
        ...
        max-width: 200px;
        width: 100px;
        background: url("https://static.zohocdn.com/iam/v2/components/images/zoho.23e9f1386f4d8aedfdf49c511c2b63dd.png") no-repeat transparent;
    ...
    .ip_block {
        background: url(https://static.zohocdn.com/iam/v2/components/images/RestrictIP.bf8deb709db3ca6f1cb8d264899f3fbb.svg) no-repeat transparent;
        background-size: auto 100%;
        background-position: center;
    }
...
<footer id="footer">
    ...
    <div style="padding:5px 0px;">
				<span>
					&copy 2022, <a href=http://www.zohocorp.com/ target=_blank style=font-size:14px;cursor:pointer;text-decoration:none;>Zoho Corporation Pvt. Ltd.</a> All Rights Reserved.
				</span>
    </div>
